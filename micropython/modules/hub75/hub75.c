...
static const mp_map_elem_t hub75_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_SHIFT_DRIVER_ICN2038S), MP_ROM_INT(3) },
    { MP_ROM_QSTR(MP_QSTR_SHIFT_DRIVER_MBI5124), MP_ROM_INT(4) },
    { MP_ROM_QSTR(MP_QSTR_SHIFT_DRIVER_DP3246), MP_ROM_INT(5) },
    { MP_ROM_QSTR(MP_QSTR_LINE_DECODER_TYPE138), MP_ROM_INT(0) },
    { MP_ROM_QSTR(MP_QSTR_LINE_DECODER_TYPE595), MP_ROM_INT(1) },
    { MP_ROM_QSTR(MP_QSTR_LINE_DECODER_TYPE_DIRECT), MP_ROM_INT(2) },
    { MP_ROM_QSTR(MP_QSTR_LINE_DECODER_SM5266P), MP_ROM_INT(3) },
